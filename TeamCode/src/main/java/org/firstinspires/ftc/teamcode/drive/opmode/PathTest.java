...
public class PathTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        strafe_builder = new TrajectoryBuilder(strafe_drive.getPoseEstimate(), DriveConstants.STRAFE_BASE_CONSTRAINTS);
        ...
        builder = new TrajectoryBuilder(drive.getPoseEstimate(), DriveConstants.BASE_CONSTRAINTS);
        builder.forward(72);
